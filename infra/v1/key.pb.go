...
type CreateRootKeyRequest struct {
	...
	UserPublicKey string                 `protobuf:"bytes,7,opt,name=user_public_key,json=userPublicKey,proto3" json:"user_public_key,omitempty"` // 用户公钥，用于保护用户的私钥分片
...
func (x *CreateRootKeyRequest) GetUserPublicKey() string {
	if x != nil {
...
const file_infra_v1_key_proto_rawDesc = "" +
	"\n" +
	"\x12infra/v1/key.proto\x12\binfra.v1\x1a\x15infra/v1/common.proto\"\xfd\x02\n" +
	...
	"\n" +
	"pagination\x18\x02 \x01(\v2\x1b.infra.v1.PaginationRequestR\n" +
	"pagination\"\x83\x01\n" +
	"\x14ListRootKeysResponse\x12-\n" +
	"\x04keys\x18\x01 \x03(\v2\x19.infra.v1.RootKeyMetadataR\x04keys\x12<\n" +
	"\n" +
	...
	"\x04tags\x18\x05 \x03(\v2*.infra.v1.DeriveWalletKeyRequest.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"N\n" +
	"\x17DeriveWalletKeyResponse\x123\n" +
	"\x06wallet\x18\x01 \x01(\v2\x1b.infra.v1.WalletKeyMetadataR\x06wallet\"2\n" +
	"\x13GetWalletKeyRequest\x12\x1b\n" +
	"\twallet_id\x18\x01 \x01(\tR\bwalletId\"K\n" +
	"\x14GetWalletKeyResponse\x123\n" +
	"\x06wallet\x18\x01 \x01(\v2\x1b.infra.v1.WalletKeyMetadataR\x06wallet\"\x93\x01\n" +
	...
	"pagination\"\x8d\x01\n" +
	"\x16ListWalletKeysResponse\x125\n" +
	"\awallets\x18\x01 \x03(\v2\x1b.infra.v1.WalletKeyMetadataR\awallets\x12<\n" +
	"\n" +
	"pagination\x18\x02 \x01(\v2\x1c.infra.v1.PaginationResponseR\n" +
	"pagination\"\xe5\x03\n" +
	...
	"\x04tags\x18\n" +
	" \x03(\v2#.infra.v1.RootKeyMetadata.TagsEntryR\x04tags\x12\x1d\n" +
	"\n" +
	...
	"\x04tags\x18\t \x03(\v2%.infra.v1.WalletKeyMetadata.TagsEntryR\x04tags\x12\x1d\n" +
	"\n" +
	"created_at\x18\n" +
	...
	"\n" +
	"GetRootKey\x12\x1b.infra.v1.GetRootKeyRequest\x1a\x1c.infra.v1.GetRootKeyResponse\x12I\n" +
...
var (
	...
	file_infra_v1_key_proto_rawDescData []byte
)

func file_infra_v1_key_proto_rawDescGZIP() []byte {
	file_infra_v1_key_proto_rawDescOnce.Do(func() {
		file_infra_v1_key_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_infra_v1_key_proto_rawDesc), len(file_infra_v1_key_proto_rawDesc)))
	})
