...
require (
    github.com/SafeMPC/mpc-servicestructure v0.1.0
    // 或者直接引用 protobuf
    github.com/SafeMPC/mpc-servicestructure/proto/infrastructure/v1 v0.1.0
)
```
...
option go_package = "github.com/SafeMPC/mpc-servicestructure/proto/infrastructure/v1";
...
# 初始化 Go 模块
go mod init github.com/SafeMPC/mpc-servicestructure
...
cd go-mpcvault-server
git submodule add https://github.com/SafeMPC/mpc-servicestructure.git proto/infrastructure

# 在 go.mod 中引用
replace github.com/SafeMPC/mpc-servicestructure/proto => ./proto/infrastructure/proto
```
...
// 使用生成的 protobuf 代码
import (
    pb "github.com/SafeMPC/mpc-servicestructure/proto/infrastructure/v1"
)
```
