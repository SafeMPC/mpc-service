...
const (
	NodeService_RegisterNode_FullMethodName          = "/infra.v1.NodeService/RegisterNode"
	NodeService_Heartbeat_FullMethodName             = "/infra.v1.NodeService/Heartbeat"
	NodeService_ListNodes_FullMethodName             = "/infra.v1.NodeService/ListNodes"
	NodeService_GetNodeConnectionInfo_FullMethodName = "/infra.v1.NodeService/GetNodeConnectionInfo"
)
...
func (c *nodeServiceClient) GetNodeConnectionInfo(ctx context.Context, in *GetNodeConnectionInfoRequest, opts ...grpc.CallOption) (*GetNodeConnectionInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, NodeService_GetNodeConnectionInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNodeServiceServer) GetNodeConnectionInfo(context.Context, *GetNodeConnectionInfoRequest) (*GetNodeConnectionInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetNodeConnectionInfo not implemented")
}
...
func _NodeService_GetNodeConnectionInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeService_GetNodeConnectionInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
