...
func (o *SwaggerSpec) initHandlerCache() {
	...
	o.Handlers["DELETE"]["/api/v1/infra/keys/{keyId}"] = true
	o.Handlers["GET"]["/api/v1/infra/backup/status"] = true
	o.Handlers["GET"]["/api/v1/infra/keys/{keyId}"] = true
	o.Handlers["GET"]["/api/v1/infra/keys"] = true
	o.Handlers["GET"]["/api/v1/infra/nodes/{nodeId}"] = true
	o.Handlers["GET"]["/api/v1/infra/nodes/{nodeId}/health"] = true
	o.Handlers["GET"]["/api/v1/infra/nodes"] = true
	o.Handlers["GET"]["/api/v1/infra/sessions/{sessionId}"] = true
	o.Handlers["GET"]["/api/v1/infra/backup/shares"] = true
	o.Handlers["POST"]["/api/v1/infra/passkeys"] = true
	o.Handlers["POST"]["/api/v1/infra/sessions/{sessionId}/cancel"] = true
	o.Handlers["POST"]["/api/v1/infra/keys"] = true
	o.Handlers["POST"]["/api/v1/infra/sessions"] = true
	o.Handlers["POST"]["/api/v1/infra/keys/derive"] = true
	o.Handlers["POST"]["/api/v1/infra/keys/{keyId}/address"] = true
	o.Handlers["POST"]["/api/v1/infra/nodes/heartbeat"] = true
	o.Handlers["POST"]["/api/v1/infra/sessions/{sessionId}/join"] = true
	o.Handlers["POST"]["/api/v1/infra/sign/batch"] = true
	o.Handlers["POST"]["/api/v1/infra/sign"] = true
	o.Handlers["POST"]["/api/v1/infra/verify"] = true
	o.Handlers["POST"]["/api/v1/infra/backup/shares/recover"] = true
	o.Handlers["POST"]["/api/v1/infra/nodes"] = true
	o.Handlers["POST"]["/api/v1/infra/nodes/register"] = true
}
